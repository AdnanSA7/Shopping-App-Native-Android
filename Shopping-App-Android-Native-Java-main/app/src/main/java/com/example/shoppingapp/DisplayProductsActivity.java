...
public class DisplayProductsActivity extends AppCompatActivity {
    ...
    ProductAdapter adapter;  // Declare the adapter
    ShoppingDatabase db;
...
//
//                Products ppp = new Products(id,image,name,priceAfter,brand,rating,quantity);
//
...
//        });
        ...
        add_to_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(DisplayProductsActivity.this).create();
                alertDialog.setTitle(name);
                alertDialog.setMessage("Click (Ok) TO PURCHASE This Product");
                alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
                        ...
                        // Set result to indicate the purchase was successful
...
//                            boolean isPurchased = db.insertProductInPurchases(ppp);
//
//                            if (isPurchased) {
//                                // Get updated product list from the database
//                                ArrayList<Products> updatedProducts = db.getAllProducts("game");
//
//                                if (updatedProducts != null && !updatedProducts.isEmpty()) {
//                                    adapter.updateProductsList(updatedProducts);  // Refresh RecyclerView with updated data
//                                    Toast.makeText(DisplayProductsActivity.this, "Purchased Successfully", Toast.LENGTH_SHORT).show();
//                                    finish();  // Optionally, finish the activity after purchase
//                                } else {
//                                    Log.e("DisplayProductsActivity", "Updated products list is empty or null.");
//                                }
//                            } else {
//                                Toast.makeText(DisplayProductsActivity.this, "Purchase Failed. Try Again.", Toast.LENGTH_SHORT).show();
//                            }
//                        }
//                    });
//                    alertDialog.show();
//                } catch (Exception e) {
//                    e.printStackTrace();
//                    Log.e("DisplayProductsActivity", "Error during purchase: " + e.getMessage());
//                    Toast.makeText(DisplayProductsActivity.this, "An error occurred during the purchase. Please try again.", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
