...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductViewHolder> {
    ...
    // New method to update the product list and refresh the RecyclerView
    @SuppressLint("NotifyDataSetChanged")
    public void updateProductsList(ArrayList<Products> newProductsList) {
        this.products = newProductsList; // Update the list of products
